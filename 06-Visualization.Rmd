...
```{r, eval=F}
expr <- read.table("analysis.simplier.DESeq2.normalized.symbol.txt", 
...
```{r}
de_gene <- read.table("analysis.DESeq2.all.DE.symbol", row.names=NULL, header=F, sep="\t")
head(de_gene)
```
